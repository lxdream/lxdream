/**
 * $Id: debugcb.c,v 1.1 2007-10-10 11:02:04 nkeynes Exp $
 *
...
void 
on_save_next_scene_activate( GtkMenuItem *menuitem,
			     gpointer user_data) 
{
...
on_disasm_list_select_row              (GtkCList        *clist,
                                        ...
                                        gpointer         user_data)
{
    debug_window_t data = get_debug_info(GTK_WIDGET(clist));
                                        ...
                                        gpointer         user_data)
{
    ...
    debug_window_t data = get_debug_info( GTK_WIDGET(editable) );
